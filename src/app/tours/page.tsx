    ...
    const fallbackData = [
      {
        ...
        features: ['Kelingking Beach', 'Angel Billabong', 'Broken Beach', 'Crystal Bay Beach', 'Professional Guide', 'Transportation', 'Tax Island', 'Parking Ticket in Any Spot'],
        isActive: true,
      ...
      },
      {
        ...
        features: ['Kelingking Beach', 'Angel Bilabong', 'Broken Beach', 'Manta Snorkeling', 'Snorkeling Equipment', 'Underwater Guide', 'Professional Guide', 'Transportation', 'Tax Island', 'Parking Ticket in Any Spot'],
        isActive: true,
      ...
      },
      {
        ...
        duration: 8,
        includesSnorkeling: false,
        features: ['Kelingking Beach', 'Broken Beach', 'Angel Bilabong', 'Diamond Beach', 'Atuh Beach', 'Full Island Experience', 'Professional Guide', 'Transportation', 'Tax Island', 'Parking Ticket in Any Spot'],
        isActive: true,
