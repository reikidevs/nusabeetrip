...
export default function TourDetailContent({ tour, relatedTours, faqItems, guideLinks = [] }: Props) {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-[1fr_360px] gap-8">
            ...
            <div className="space-y-10">
              ...
              {/* Related guides — internal links to topical articles */}
              {guideLinks.length > 0 && (
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-brand-blue-800 mb-2">
                    {language === 'id' ? 'Panduan terkait' : 'Related guides'}
                  </h2>
                  <p className="text-gray-600 mb-5">
                    {language === 'id'
                      ? 'Baca panduan kami untuk mempersiapkan tur ini.'
                      : 'Read our guides to plan for this tour.'}
                  </p>
                  <div className="grid sm:grid-cols-2 gap-4">
                    {guideLinks.map((g) => (
                      <Link
                        key={g.href}
                        href={g.href}
                        className="group flex items-start gap-3 bg-white rounded-xl border border-gray-100 p-4 hover:shadow-lg transition-all hover:-translate-y-0.5"
                      >
                        <span className="flex-shrink-0 w-9 h-9 rounded-lg bg-brand-teal-600/10 text-brand-teal-700 flex items-center justify-center">
                        ...
                        <span className="min-w-0">
                          ...
                          {g.sub && (
                            <span className="block text-xs text-gray-500 mt-1">{g.sub}</span>
                          )}
                        </span>
                      </Link>
                    ))}
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-lg">
                ...
                <div className="space-y-2.5 mb-6 pb-6 border-b border-gray-100">
                  ...
                  <div className="flex items-center gap-2.5 text-sm text-gray-600">
                    ...
                    {language === 'id'
                      ? 'Layanan WhatsApp 08.00–22.00 WITA'
                      : 'WhatsApp service 08:00–22:00 WITA'}
                  </div>
                </div>
