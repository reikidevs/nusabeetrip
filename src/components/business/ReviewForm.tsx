...
export default function ReviewForm({ isOpen, onClose, onSuccess, defaultTour }: ReviewFormProps) {
  ...
  const labels = {
    en: {
      ...
      googlePromptTitle: 'Would you also share it on Google?',
      googlePromptBody: 'Website reviews cannot be sent to Google automatically. Copy your text, then submit it yourself while signed in to Google Maps.',
      copyAndOpenGoogle: 'Copy & open Google Maps',
      copyAndFindGoogle: 'Copy & find us on Google Maps',
      ...
      googleDisclosure: 'Submitting here does not publish anything to Google Maps.',
    },
    id: {
      title: 'Tulis Ulasan',
      ...
      googlePromptTitle: 'Mau membagikannya juga di Google?',
      googlePromptBody: 'Ulasan website tidak dapat dikirim otomatis ke Google. Salin teksnya, lalu kirim sendiri setelah login di Google Maps.',
      copyAndOpenGoogle: 'Salin & buka Google Maps',
      copyAndFindGoogle: 'Salin & cari kami di Google Maps',
      ...
      googleDisclosure: 'Mengirim di sini tidak otomatis memublikasikan apa pun ke Google Maps.',
    },
  };
          ...
          <div className="p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-white hover:bg-gray-50 text-gray-800 border border-gray-300 rounded-lg font-semibold transition-colors"
              >
