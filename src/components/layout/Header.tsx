        ...
        <div className="border-t border-gray-100 bg-white px-4 py-4 space-y-1">
          ...
          <div className="pt-4 mt-2 border-t border-gray-100 space-y-3">
            ...
            <div className="flex justify-center gap-6 text-sm text-gray-500">
              <a href="tel:+6289631281234" className="inline-flex items-center gap-1.5 hover:text-brand-blue-800 transition-colors">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                Call
              </a>
              <a href="mailto:sidiqdwiatmoko@gmail.com" className="inline-flex items-center gap-1.5 hover:text-brand-blue-800 transition-colors">
              ...
              <a href="https://instagram.com/sidiq_1312" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 hover:text-brand-blue-800 transition-colors">
